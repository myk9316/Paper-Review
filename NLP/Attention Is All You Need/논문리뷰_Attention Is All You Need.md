...
- 본 논문에서는, Recurrence를 피하고 input과 output의 global dependecy를 찾는 attention 매커니즘에 전적으로 기반하는 Transformer를 제안한다. Transformer 구조는 병렬처리를 가능하게 하고 번역의 질에 있어서 새로운 SOTA를 달성할 수 있다. 
