...
- MF의 장점은 추가적인 정보의 통합을 허용한다. 즉, 명시적 피드백을 사용할 수 없을 때, 추천시스템은 사용자의 구매이력, 브러우적 기록, 검색 패턴, 마우스 움직임 등의 암시적(implicit) 피드백을 사용하여 해당 사용자의 선호를 파악할 수 있다. 암시적 피드백은 주로 Dense Matrix로 표현된다. 
